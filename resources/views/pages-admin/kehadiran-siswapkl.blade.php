...
=======
                    <tr class="text-gray-900 text-sm">
                        ...
                        <th class="py-3 px-4 text-left text-sm font-semibold text-gray-900 border-b border-gray-300">Tanggal</th>
                        <th class="py-3 px-4 text-center text-sm font-semibold text-gray-900 border-b border-gray-300">Waktu Masuk</th>
                        <th class="py-3 px-4 text-center text-sm font-semibold text-gray-900 border-b border-gray-300">Waktu Keluar</th>
                        <th class="py-3 px-4 text-center text-sm font-semibold text-gray-900 border-b border-gray-300">Foto Masuk</th> <!-- Foto Masuk column -->
                        <th class="py-3 px-4 text-center text-sm font-semibold text-gray-900 border-b border-gray-300">Foto Keluar</th> <!-- Foto Keluar column -->
                        <th class="py-3 px-4 text-center text-sm font-semibold text-gray-900 border-b border-gray-300">Foto Izin</th> <!-- Foto Izin column -->
                        <th class="py-3 px-4 text-center text-sm font-semibold text-gray-900 border-b border-gray-300">Status</th> <!-- Status column moved -->
                    </tr>
                </thead>
                <tbody class="text-gray-900 text-sm font-light">
                    <!-- Data example for "Hadir" -->
                    <tr class="bg-white hover:bg-gray-50 transition duration-200 ease-in-out">
                        <td class="py-4 px-4 border-b border-gray-300 text-gray-900">1</td>
                        <td class="py-4 px-4 border-b border-gray-300 text-gray-900">Nur Khotijah</td>
...
=======
                    ...
                    <!-- Data example for "Izin" -->
                    <tr class="bg-white hover:bg-gray-50 transition duration-200 ease-in-out">
                        <td class="py-4 px-4 border-b border-gray-300 text-gray-900">2</td>
                        <td class="py-4 px-4 border-b border-gray-300 text-gray-900">Fitri Amaliah</td>
...
=======
                    ...
                    <!-- Data example for "Tidak Hadir" -->
                    <tr class="bg-white hover:bg-gray-50 transition duration-200 ease-in-out">
                        <td class="py-4 px-4 border-b border-gray-300 text-gray-900">3</td>
                        <td class="py-4 px-4 border-b border-gray-300 text-gray-900">Rahmat Hidayat</td>
                        <td class="py-4 px-4 border-b border-gray-300 text-gray-900">2024-10-03</td>
                        <td class="py-4 px-4 border-b border-gray-300 text-center text-gray-900">-</td>
                        <td class="py-4 px-4 border-b border-gray-300 text-center text-gray-900">-</td>
                        <td class="py-2 px-4 border-b text-center"></td> <!-- Empty for "Tidak Hadir" -->
                        <td class="py-2 px-4 border-b text-center"></td> <!-- Empty for "Tidak Hadir" -->
