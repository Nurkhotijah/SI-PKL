    ...
    <div class="max-w-7xl mx-auto bg-white p-4 sm:p-6 rounded-lg shadow-md">
        ...
        <div class="mb-4">
            ...
            <div class="flex items-center">
                <label class="mr-2" for="dateFilter">Tanggal:</label>
                <input class="border rounded p-2" id="dateFilter" type="date" onchange="filterByDate()" />
            </div>
        </div>
...
<script>
    ...
    let currentPage = 1;
    const rowsPerPage = 5; // Changed to 10 rows per page
