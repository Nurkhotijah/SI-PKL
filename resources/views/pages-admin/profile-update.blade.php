...
<body class="bg-gray-100 flex items-center justify-center min-h-screen">
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    ...
                    <div class="space-y-2">
                        ...
                        <textarea id="alamat" name="alamat" rows="3" 
                            class="w-full border border-gray-300 focus:border-blue-500 focus:ring-2 focus:ring-blue-200 rounded-lg p-2 text-sm shadow-sm transition">Jl. Raya No. 123, Bogor, Jawa Barat</textarea>
                    </div>
            
                    <div class="space-y-2">
                        <label for="email" class="block font-medium text-gray-700 text-sm">Email</label>
                        <input type="email" id="email" name="email" 
                            value="info@smk1bogor.sch.id" 
                            class="w-full border border-gray-300 focus:border-blue-500 focus:ring-2 focus:ring-blue-200 rounded-lg p-2 text-sm shadow-sm transition">
                    </div>
                </div>
    ...
    window.location.href = "{{ route('profile-admin') }}"; // Menggunakan route Laravel
}
