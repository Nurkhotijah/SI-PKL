    ...
    <div class="flex h-screen">
        ...
        <div id="sidebar" class="fixed inset-0 w-64 md:w-1/6 bg-gray-800 text-white flex flex-col shadow-lg z-30 transition-transform transform md:relative md:block md:translate-x-0 -translate-x-full">
            ...
            <div class="mt-4 flex-grow">
              <ul>
                <li class="p-3 {{ request()->is('pages-admin/dashboard-admin') ? 'bg-green-600' : 'hover:bg-gray-700' }} flex items-center space-x-2">
                ...
                <li class="p-3 {{ request()->is('kehadiran-siswapkl') ? 'bg-green-600' : 'hover:bg-gray-700' }} flex items-center space-x-2">
                ...
                <li class="p-3 {{ request()->is('pengajuan-siswa') ? 'bg-green-600' : 'hover:bg-gray-700' }} flex items-center space-x-2">
                ...
                <li class="p-3 {{ request()->is('data-siswa') ? 'bg-green-600' : 'hover:bg-gray-700' }} flex items-center space-x-2">
                ...
                {{-- <li class="p-3 {{ request()->is('pengajuan') ? 'bg-green-600' : 'hover:bg-gray-700' }} flex items-center space-x-2">
                  <img width="30" height="30" src="https://img.icons8.com/ios/50/FFFFFF/book--v1.png" alt="book--v1"/>
                  <a href="{{ route('pengajuan') }}" class="text-sm">Pengajuan Izin Siswa</a>
                </li> --}}
                ...
                {{-- <li class="p-3 {{ request()->is('nilai-siswa') ? 'bg-green-600' : 'hover:bg-gray-700' }} flex items-center space-x-2">
                  <img width="30" height="30" src="https://img.icons8.com/ios/50/FFFFFF/permanent-job.png" alt="permanent-job"/>
                  <a href="{{ route('nilai-siswa') }}" class="text-sm">Nilai Siswa</a>
                </li>
                <li class="p-3 {{ request()->is('rekap-kehadiransiswa') ? 'bg-green-600' : 'hover:bg-gray-700' }} flex items-center space-x-2">
                  <img width="30" height="30" src="https://img.icons8.com/ios/50/FFFFFF/test-results.png" alt="test-results"/>
                  <a href="{{ route('rekap-kehadiransiswa') }}" class="text-sm">Rekap Kehadiran Siswa</a>
                </li> --}}
              </ul>
            </div>
        </div>
